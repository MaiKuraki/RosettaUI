...
## [1.10.0](https://github.com/MaiKuraki/RosettaUI/compare/ga.fuquna.rosettaui.uitoolkit-v1.9.2...ga.fuquna.rosettaui.uitoolkit-v1.10.0) (2025-07-05)


### Features

* add blur to line edge ([1a2f93f](https://github.com/MaiKuraki/RosettaUI/commit/1a2f93f9d807d77c461b99c69ada6977f870c6d9))
...
* add new render path using SDFs ([b846911](https://github.com/MaiKuraki/RosettaUI/commit/b84691131f7b0599f81a612624325e66178f0fd1))
* add reordering of the control points ([a4e4727](https://github.com/MaiKuraki/RosettaUI/commit/a4e47270cf6d2c67d475366e0a57701fecfa85e8))
* add UI.PopupMenuButton() ([7ee2ded](https://github.com/MaiKuraki/RosettaUI/commit/7ee2ded79cb0d1c8502557a4532e9d5c19cd449e))
* add/remove control point ([63be723](https://github.com/MaiKuraki/RosettaUI/commit/63be7233c58b2617ce54125889818fc152e24159))
* angle Snapping, clean: add previewTransform to manage preview position and scale ([72f41e3](https://github.com/MaiKuraki/RosettaUI/commit/72f41e308d8e887d8fa26ad7c779eae3fa979737))
...
* animation curve handle ([c82c587](https://github.com/MaiKuraki/RosettaUI/commit/c82c58730afff7bd4c40603ae82c8563cf7f3329))
* axis label ([8fbf111](https://github.com/MaiKuraki/RosettaUI/commit/8fbf111c99620826425b1073f8bfed72a7b7aa64))
* depends on RosettaUI 1.7.0 ([60ceeb9](https://github.com/MaiKuraki/RosettaUI/commit/60ceeb99a6abe08f97fb274bd319a66fc9efb747))
...
* matching the tangent mode of new control point to neighbor one ([6bdf0f0](https://github.com/MaiKuraki/RosettaUI/commit/6bdf0f0a73ed9d818650f02dd022abdf9935be24))
...
* popupMenu of ControlPoint ([a135ebb](https://github.com/MaiKuraki/RosettaUI/commit/a135ebb59bb46af65515d58ba31171f2df3bd28e))
* render curve handle ([c77b78c](https://github.com/MaiKuraki/RosettaUI/commit/c77b78c7f85435eddaff51b1d65fe32fe855cc4c))
...
* show control points ([9aefcc5](https://github.com/MaiKuraki/RosettaUI/commit/9aefcc5ccff74fba5e5a6c7a28ea1f7acdcee69a))
* switch to new render path ([4db0115](https://github.com/MaiKuraki/RosettaUI/commit/4db0115ed85da369d8e4217562efe113faf437fe))
* tangent field ui ([da1ca37](https://github.com/MaiKuraki/RosettaUI/commit/da1ca37d76940b2f04ad5470748a89973ff92731))
* time and value field ([db2da90](https://github.com/MaiKuraki/RosettaUI/commit/db2da903697093ba81f3fb2516cecec8680913e6))
* zoom each axis ([2bc13e7](https://github.com/MaiKuraki/RosettaUI/commit/2bc13e7b672ecef48e605e42498167068aaca7f3))


### Bug Fixes

* [#31](https://github.com/MaiKuraki/RosettaUI/issues/31) remove UnityInternalAccess ([b63ce8b](https://github.com/MaiKuraki/RosettaUI/commit/b63ce8b90e64132be2cb74b32d37c28927cfe78c))
* Add keywords to package.json to get hits in npmjs search ([2515946](https://github.com/MaiKuraki/RosettaUI/commit/25159468c4597d511f3fa3dfe7eca35702091be6))
* AnimactionCurveEditor error when there is no key on the animation curve. ([487fb73](https://github.com/MaiKuraki/RosettaUI/commit/487fb7331531cf60cb67bdb6ece5a474b0e962e5))
* AnimationCurveEditor design at Unity2022 ([9b12747](https://github.com/MaiKuraki/RosettaUI/commit/9b12747566715608c4fe486551094a2c1e9476b6))
* Build error when updating from 1.7.0 or earlier to 1.7.1 ([c66955f](https://github.com/MaiKuraki/RosettaUI/commit/c66955f9777c21dfef2e96660da200739c9564b4))
...
* Incorrect size of check mark in dropdown in Unity2022 ([b46b738](https://github.com/MaiKuraki/RosettaUI/commit/b46b7388c927e7eb47b8c2682cbabf2376552f90))
* Invalid Min/MaxHeight when Width is set and vice versa ([b9793d8](https://github.com/MaiKuraki/RosettaUI/commit/b9793d8b42c89c93b93c0547be3aa9a16372d2f3))
* style changed ([a5f89c6](https://github.com/MaiKuraki/RosettaUI/commit/a5f89c61b7364fd148df8c20baf12821561c238a))
* typo ([8837f3c](https://github.com/MaiKuraki/RosettaUI/commit/8837f3cd8ba874dd4c891daa4586ad4780c1f1f9))
* UI.Fold() does not display Field when left side of header is Label and right side is Field. (PopupMenu flex-shrink: 0) ([3580c0d](https://github.com/MaiKuraki/RosettaUI/commit/3580c0d96321a4bc0615fe323bf0cab328b312c1))
* unintended ui being displayed when using DynamicElement ([df99249](https://github.com/MaiKuraki/RosettaUI/commit/df99249c149e2c1a00d58a8d6e9036c2150a9789))
* unintended ui being displayed when using DynamicElement ([5534d83](https://github.com/MaiKuraki/RosettaUI/commit/5534d83340e7f4a131313d6f819b3f36c48872a8))
* Unity2022 compile error ([b1c2e6a](https://github.com/MaiKuraki/RosettaUI/commit/b1c2e6a364bc73e60074ea794b78204753909f03))
* Unnatural scrollbar in dropdown menu at Unity6. ([4871a3b](https://github.com/MaiKuraki/RosettaUI/commit/4871a3ba85c023155600436f20e63a2c2062af25))
* view fix bug etc. ([cfb9f48](https://github.com/MaiKuraki/RosettaUI/commit/cfb9f4808c5d5e2a50066dac0331ecaadda91e33))


### Performance Improvements

* Fold content is not generated until the first time it is displayed. [#14](https://github.com/MaiKuraki/RosettaUI/issues/14) ([3c38327](https://github.com/MaiKuraki/RosettaUI/commit/3c38327ffb8a42a500c14fa391a510894369beb5))
